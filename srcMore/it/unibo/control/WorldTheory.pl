%==============================================
% WorldTheory.pl for actor control
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatucontrol).	%%old version (deprecated)
actorobj(qatucontrol).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor control
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of control" ). 
...
%-------------------------------------------------
%  User static rules about control
%------------------------------------------------- 
/*
------------------------------------------------------------------------
