%==============================================
% WorldTheory.pl for actor sonarobstacle
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonarobstacle).	%%old version (deprecated)
actorobj(qatusonarobstacle).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonarobstacle
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonarobstacle" ). 
...
%-------------------------------------------------
%  User static rules about sonarobstacle
%------------------------------------------------- 
/*
------------------------------------------------------------------------
