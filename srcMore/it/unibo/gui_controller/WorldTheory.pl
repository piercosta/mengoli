%==============================================
% WorldTheory.pl for actor gui_controller
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatugui_controller).	%%old version (deprecated)
actorobj(qatugui_controller).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor gui_controller
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of gui_controller" ). 
...
%-------------------------------------------------
%  User static rules about gui_controller
%------------------------------------------------- 
/*
------------------------------------------------------------------------
