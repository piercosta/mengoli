%==============================================
% WorldTheory.pl for actor qaconsole
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaconsole).	%%old version (deprecated)
actorobj(qatuqaconsole).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaconsole
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaconsole" ). 
...
%-------------------------------------------------
%  User static rules about qaconsole
%------------------------------------------------- 
/*
------------------------------------------------------------------------
