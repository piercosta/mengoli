%==============================================
% WorldTheory.pl for actor logic_controller
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatulogic_controller).	%%old version (deprecated)
actorobj(qatulogic_controller).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor logic_controller
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of logic_controller" ). 
...
%-------------------------------------------------
%  User static rules about logic_controller
%------------------------------------------------- 
/*
------------------------------------------------------------------------
