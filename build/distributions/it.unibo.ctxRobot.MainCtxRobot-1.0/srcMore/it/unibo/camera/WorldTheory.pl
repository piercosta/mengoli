%==============================================
% WorldTheory.pl for actor camera
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatucamera).	%%old version (deprecated)
actorobj(qatucamera).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor camera
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of camera" ). 
...
%-------------------------------------------------
%  User static rules about camera
%------------------------------------------------- 
/*
------------------------------------------------------------------------
