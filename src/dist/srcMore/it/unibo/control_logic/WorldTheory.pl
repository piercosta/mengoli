%==============================================
% WorldTheory.pl for actor control_logic
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatucontrol_logic).	%%old version (deprecated)
actorobj(qatucontrol_logic).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor control_logic
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of control_logic" ). 
...
%-------------------------------------------------
%  User static rules about control_logic
%------------------------------------------------- 
/*
------------------------------------------------------------------------
