%==============================================
% WorldTheory.pl for actor obstaclesonar
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuobstaclesonar).	%%old version (deprecated)
actorobj(qatuobstaclesonar).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor obstaclesonar
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of obstaclesonar" ). 
...
%-------------------------------------------------
%  User static rules about obstaclesonar
%------------------------------------------------- 
/*
------------------------------------------------------------------------
